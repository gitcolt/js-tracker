...
const row = props =>
    <div style={{height: props.height + 'px', boxSizing: 'border-box', display: 'flex', whiteSpace: 'nowrap', background: 'lightgray', padding: '5px', fontFamily: 'Roboto Mono'}}>
        ...
        {props.row.map((track, i) =>
            <div key={i} style={{fontFamily: 'Roboto Mono', background: 'lightgreen'}}>
                ...
                <span style={{background: (props.isRowSelected && (2*i + 1) === props.curColumn) ? 'pink' : '', color: 'blue'}}>
